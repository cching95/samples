...
from rtdip_sdk.pipelines.transformers.spark.pcdm_to_honeywell_apm import PCDMToHoneywellAPMTransformer
from rtdip_sdk.pipelines.destinations.spark.eventhub import SparkEventhubDestination
import json
from pyspark.sql import SparkSession

spark = (
    SparkSession.builder.appName("EventhubPipelineSample").config("spark.jars.packages", "com.microsoft.azure:azure-eventhubs-spark_2.12:2.3.22").getOrCreate()
)
